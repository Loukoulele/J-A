              ...
              <div className="row align-items-center">
                ...
                <div className="col-lg-3 col-md-6 col-6">
                  <div className="navbar-header">
                    {/* <NavLink onClick={ClickHandler} className="navbar-brand logo" to="/home">Jul<span>i<i className="fa fa-heart" aria-hidden="true"></i></span>e & Avner</NavLink> */}
                    <NavLink onClick={ClickHandler} className="navbar-brand logo" to="/home">J & A</NavLink>
                  </div>
                </div>
